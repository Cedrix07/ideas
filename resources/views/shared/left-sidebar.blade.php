<div class="card overflow-hidden">
    <div class="card-body pt-3">
        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
            ...
            <li class="nav-item">
                <a class="{{ ( Request::is('feed')) ? 'text-white bg-primary rounded' : 'text-dark'}} nav-link" href="{{route('feed')}}">
                    <span>Feed</span></a>
            </li>
            <li class="nav-item">
                <a class="{{ ( Request::is('terms')) ? 'text-white bg-primary rounded' : 'text-dark'}} nav-link" href="{{route('terms')}}">
                    <span>Terms</span></a>
            </li>
        </ul>
    </div>
